...
int main(int argc, char **argv)
{
    ...
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    shapes::Mesh *m1 = shapes::createMeshFromResource("package://attach_obj_melodic/meshes/torus_small.stl");
    ...
    mesh_collision_object.header.frame_id = "panda_hand";
    mesh_collision_object.id = "torus";
